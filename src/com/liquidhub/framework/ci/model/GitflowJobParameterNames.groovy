...
enum GitflowJobParameterNames {
	...
	UPDATE_INTERNAL_POM_DEPENDENCIES_TO_LATEST_VERSIONS('updateInternalPOMDependenciesToLatestVersions', 'Determines if the internal/inhouse dependencies of this project will automatically be upgraded to the latest version available while the feature is being finished'),
