...
enum GitflowJobParameterNames {
	...
	FEATURE_PRODUCTION_DATE('featureProductionMonthAndYear', 'Enter the intended release of feature in production expressed in month and year. It is perfectly acceptable if the date changes later.binding Use the format mm/yyyyy. E.g. for October 2015 release, enter 10/2015'),
