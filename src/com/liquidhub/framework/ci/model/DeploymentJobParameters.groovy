...
enum DeploymentJobParameters {
	...
	TARGET_CLUSTER_NAME(new JobParameter(name: 'targetClusterName', description: 'The Cluster/JVM Name for which the deployment is targeted.You do not have to change this value',elementType: ViewElementTypes.READ_ONLY_TEXT)),
	TARGET_CELL_NAME(new JobParameter(name:'targetCellName',description: 'The cell for which the deployment is targeted.You do not have to change this value', elementType: ViewElementTypes.READ_ONLY_TEXT)),
	APP_CONTEXT_ROOT(new JobParameter(name:'applicationContextRoot',description: 'The Web Application context root, you do not HAVE to change this value', elementType: ViewElementTypes.READ_ONLY_TEXT))
